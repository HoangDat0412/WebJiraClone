...
import { AddTaskActionApi, DeleteTaskActionApi, RejectTaskActionApi, getTaskListAPI } from '../../Redux/actions/ToDoListAction';
...
export default function ToDoListRedux() {
    ...
    const addTask = (e) => {
        ...
        dispatch(AddTaskActionApi(state.values.taskName))
    }
    ...
    const rejectTask = (taskName)=>{
        dispatch(RejectTaskActionApi(taskName))
   ...
   const  checkTask = (taskName) => {
    ...
    const delTask = (taskName) => {
        dispatch(DeleteTaskActionApi(taskName))
    }
